// Grade Analysis
// Professor Graham is wrote some simple code to help him determine 
// the average and median scores on each of his quarterly exams, 
// but some of the test cases are failing. Figure out why, 
...
function median(nums) {
  ...
  nums.sort((a, b) => a - b); // fix
  // nums.sort(); // sort by string Unicode, should be nums.sort((a, b) => a - b);
