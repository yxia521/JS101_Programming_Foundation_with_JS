...
function completeTasks(n = 1) {
  ...
  while (todos.length > 0 && tasksComplete < n) {
    ...
    delete todos[0]; // todos.shift(); OR todos.splice(0, 1)
    tasksComplete++;
  }
...
// The length of the array remains the same, and using bracket notation with the deleted item's index 
// will return undefined. Using delete with an array can therefore lead to unexpected results and 
...
// Another very useful method for deleting array elements is Array.prototype.splice(). mutating
